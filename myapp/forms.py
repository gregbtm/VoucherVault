...
class ItemForm(forms.ModelForm):
    ...
    class Meta:
        model = Item
        fields = [
            'name', 'issuer', 'redeem_code', 'card_number', 'pin',
            'issue_date', 'expiry_date', 'description', 'logo_slug', 'type',
            'value', 'value_type', 'currency', 'file', 'code_type',
            'tile_color', 'wallet', 'tags', 'notes', 'share_message',
            'notify_days_before', 'notifications_muted', 'balance_check_url',
            'journey_origin', 'journey_destination', 'travel_time', 'order_id',
            'discount_applied', 'is_recurring', 'renewal_period', 'renewal_date',
            'minimum_spend', 'points_balance', 'membership_tier', 'initial_value',
            'seat_number', 'firefly_account_id', 'firefly_rule',
        ]
        widgets = {
...
class SiteConfigurationForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            'email_use_tls', 'email_use_ssl', 'email_from_address',
        ...
        widgets = {
            ...
            'pocket_id_url': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'https://id.example.com'}),
            ...
            'email_host_user': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'you@example.com', 'autocomplete': 'off'}),
            ...
            'email_from_address': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'VoucherVault Plus+ <vault@example.com>'}),
