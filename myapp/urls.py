...
urlpatterns = (
    ...
    path('items/<uuid:item_uuid>/comments/add', views.add_item_comment, name='add_item_comment'),
    path('comments/<int:comment_id>/delete', views.delete_item_comment, name='delete_item_comment'),
    ...
    path('developer/test-fixer/', views.test_fixer_key, name='test_fixer_key'),
    path('developer/test-ocr/', views.test_ocr_connectivity, name='test_ocr_connectivity'),
    ...
    path('admin-tools/send-test-email/', views.send_test_email, name='send_test_email'),
